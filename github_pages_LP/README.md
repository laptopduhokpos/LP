...
1. Ù‡Û•Ù…ÙˆÙˆ Ù†Ø§ÙˆÛ•Ú•Û†Ú©ÛŒ Ø¦Û•Ù… ÙÛ†ÚµØ¯Û•Ø±Û• (`github_pages_LP/`) upload Ø¨Ú©Û• Ø¨Û† root Ù€ÛŒ repo `laptopduhokpos/LP`
2. Settings â†’ Pages â†’ Deploy from branch `main` / root
3. Firebase Console â†’ Authentication â†’ Authorized domains â†’ `laptopduhokpos.github.io`
